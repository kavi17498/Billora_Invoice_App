...
class _InvoiceListPageState extends State<InvoiceListPage> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // Download option removed for this version - will be added in future versions
              _buildOptionTile(
  ...
  Future<void> _shareInvoice(Map<String, dynamic> invoice) async {
    try {
      // Show a brief message indicating that the PDF is being generated for sharing
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
              'Generating PDF for sharing... (Note: Download option will be available in a future version)'),
      ...
      // Navigate to RegenPage and pass all required parameters for PDF generation.
      // This follows the same structure as regenerateInvoice method
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (_) => RegenPage(
  ...
  // This method was removed because PDF generation is now handled by RegenPage
  // and the corresponding PDF helper methods are no longer needed
